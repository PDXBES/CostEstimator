...
namespace CostEstimatorAddIn
{
    class CostEstimatorClass
    {
        ...
        public void PerformCostEstimates(FileInfo sFile)
        {
            ...
            double hazardousMaterialsCost = 50.0;//dollars
            double envMitigationCost = 150000; //dollars.  Should this really be 150,000?
            double envMitigationWidth = 25.0; //feet
            double asphaltRemovalCost = 8.12; //dollars
            double excessAsphaltWidth = 1.0; //feet
            ...
            double pipeZoneDepthAdditionalInches = 18.0; //inches
            double fillAbovePipeZoneCost = 27.3; //dollars
            double pipeZoneBackfillCost = 70.55; //dollars
            double sawcutPavementLength = 4.0; //inches?
            ...
            double shoringSquareFeetPerFoot = 2.0; //
            double ShoringCostPerSquareFoot = 2.57; //dollars
            double minShoringDepth = 18.0;//feet
            string material = "";
            double workingHoursPerDay = 8.0; //hours
            double excavationDuration = 140.0; //cubic yards per day
            double paveDuration = 250.0; //feet per day
            double utilityCrossingDuration = 0.5;// working days
            double smallBoreJackDiameter = 24.0; //inches
            double largeBoreJackDiameter = 60.0; //inches
            double fastBoreRate = 100.0; //feet/day
            double slowBoreRate = 50.0;//feet/day
            double boreJackCasingAndGroutingDays = 2.0; //days
            double CIPPRepairDays = 3.0;//days
            double shallowSpotDepthCutoff = 20.0; //feet
            double shallowSpotRepairTime = 4.0;//hours
            double deepSpotRepairTime = 8.0;//hours
            double streetTypeStreetTrafficControlMobilization = 1.0;//hours 
            double streetTypeArterialTrafficControlMobilization = 2.0; //hours
            double streetTypeMajorArterialTrafficControlMobilization = 3.0;//hours
            double shallowTrenchDepthCutoff = 20.0; //feet
            double smallMainlineBypassCutoff = 15.0; //inches
            double manholeBuildRate = 10.0; //feet per day
            double lateralTrenchWidth = 4.0; //feet
            double lateralShoringLength = 10.0; //feet
            double boreJackArea = 460.0; //square feet
            double boreJackDepth = 25.0;//feet
            ...
            double streetTypeStreetTrafficControlCost = 500.0; //dollars
            double streetTypeArterialTrafficControlCost = 1000.0; // dollars 
            double streetTypeMajorArterialTrafficControlCost = 3000.0; //dollars
            double streetTypeFreewayTrafficCost = 0.0; //dollars
            double boringJackingCost = 566.95; //dollar bills
            double baseENR = 8090.0; //unitless
            double jackingENR = 9500.0;//unitless
            double difficultAreaFactor = 1.5;
            double currentENR = 10379.0; // unitless
            ...
            double daysForWholePipeLinerConstruction = 3.0;//days
